...
| [Qwen3-TTS Base](./llama-cpp.md#qwen3-tts) | Text to speech | 1.7B | `docker run -d --rm --gpus all -p 127.0.0.1:8080:8080 --mount "type=bind,source=$(pwd)/reference.wav,target=/models/reference.wav,readonly" ghcr.io/kaito-project/aikit/qwen3-tts:1.7b-base --config-file=/config.yaml` | `qwen3-tts` | [Apache 2.0](https://huggingface.co/Qwen/Qwen3-TTS-12Hz-1.7B-Base) |
